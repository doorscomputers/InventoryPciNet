...
namespace Inventory.Module.Controllers
{
    ...
    public partial class ManualInvController1 : ViewController
    {
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        public ManualInvController1()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            TargetObjectType = typeof(ManualInventory); // Target Manual Inventory
        ...
        private void ApplyBranchFilter()
        {
            ...
            if (user?.Branch != null && View is ListView listView)
            {
                ...
                listView.CollectionSource.Criteria["FilterManualInvByBranchUsrT"] = filterCriteria;
            }
        }
    }
}
